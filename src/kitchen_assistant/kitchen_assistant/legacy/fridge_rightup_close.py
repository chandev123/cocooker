...
def do_motion_demo(movej, movel, posx, wait, gripper):
    ...
    movel(posx([672.708, -80.844, 417.864, 179.972, -90.238, -90.173]), vel=VELOCITY, acc=ACC)
    wait(0.5)

    gripper.close_gripper()
    time.sleep(0.2)
    
    movel(posx([872.708, -80.844, 417.864, 179.972, -90.238, -90.173]), vel=VELOCITY, acc=ACC)
    wait(0.5)
