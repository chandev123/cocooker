...
PICK_PUSH_DIST  = 35                    # 최종 집기 시 대상 쪽으로 더 밀어주는 거리(기존 z - PICK_DZ 의미)
...
class ApplePickNode(Node):
    ...
    def pick_sequence(self, target_xyz, approach_axis, approach_sign):
        ...
        movel(posx([0.0, 0.0, 200.0, 0.0, 0.0, 0.0]), vel=VELOCITY, acc=ACC, 
...
if __name__ == "__main__":
    ...
    J_align = [-22.57, 6.146, 114.618, -96.798, 64.474, -148.839]   # 원하는 초기 조인트각(도)로 바꾸세요
